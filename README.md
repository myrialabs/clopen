...
- **System Tools Installer** — Install Git, Claude Code, OpenCode, Chrome, and Cloudflared (for Public Tunnel) straight from the admin Settings UI, with live install output streamed to the browser via xterm.js
