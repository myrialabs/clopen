...
**Decision:** Built-in Cloudflare Tunnel support; the `cloudflared` binary is installed on demand from **Settings → Stack** (the panel formerly labelled "System Tools"; not auto-downloaded on first tunnel use).
